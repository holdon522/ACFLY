...
typedef struct __mavlink_sys_status_t {
 ...
 uint32_t pos_Cflags; /*<  Bitmap indicating which position sensor is connected.*/
 uint32_t pos_Aflags; /*<  Bitmap indicating which position sensor is available.*/
 uint16_t IMU_Cflags; /*<  Bitmap indicating which IMU sensor is connected.*/
 uint16_t IMU_Aflags; /*<  Bitmap indicating which IMU sensor is calibrated.*/
}) mavlink_sys_status_t;

#define MAVLINK_MSG_ID_SYS_STATUS_LEN 55
#define MAVLINK_MSG_ID_SYS_STATUS_MIN_LEN 31
#define MAVLINK_MSG_ID_1_LEN 55
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
    ...
    {  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "pos_Cflags", NULL, MAVLINK_TYPE_UINT32_T, 0, 43, offsetof(mavlink_sys_status_t, pos_Cflags) }, \
         { "pos_Aflags", NULL, MAVLINK_TYPE_UINT32_T, 0, 47, offsetof(mavlink_sys_status_t, pos_Aflags) }, \
         { "IMU_Cflags", NULL, MAVLINK_TYPE_UINT16_T, 0, 51, offsetof(mavlink_sys_status_t, IMU_Cflags) }, \
         { "IMU_Aflags", NULL, MAVLINK_TYPE_UINT16_T, 0, 53, offsetof(mavlink_sys_status_t, IMU_Aflags) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
 ...
 * @param pos_Cflags  Bitmap indicating which position sensor is connected.
 * @param pos_Aflags  Bitmap indicating which position sensor is available.
 * @param IMU_Cflags  Bitmap indicating which IMU sensor is connected.
 * @param IMU_Aflags  Bitmap indicating which IMU sensor is calibrated.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4, uint32_t onboard_control_sensors_present_extended, uint32_t onboard_control_sensors_enabled_extended, uint32_t onboard_control_sensors_health_extended, uint32_t pos_Cflags, uint32_t pos_Aflags, uint16_t IMU_Cflags, uint16_t IMU_Aflags)
{
    ...
    _mav_put_uint32_t(buf, 43, pos_Cflags);
    _mav_put_uint32_t(buf, 47, pos_Aflags);
    _mav_put_uint16_t(buf, 51, IMU_Cflags);
    _mav_put_uint16_t(buf, 53, IMU_Aflags);
    ...
    packet.pos_Cflags = pos_Cflags;
    packet.pos_Aflags = pos_Aflags;
    packet.IMU_Cflags = IMU_Cflags;
    packet.IMU_Aflags = IMU_Aflags;
...
static inline uint16_t mavlink_msg_sys_status_pack_chan_full(uint8_t system_id, uint8_t component_id, uint8_t chan,
                               mavlink_message_t* msg,
                                   uint32_t onboard_control_sensors_present,uint32_t onboard_control_sensors_enabled,uint32_t onboard_control_sensors_health,uint16_t load,uint16_t voltage_battery,int16_t current_battery,int8_t battery_remaining,uint16_t drop_rate_comm,uint16_t errors_comm,uint16_t errors_count1,uint16_t errors_count2,uint16_t errors_count3,uint16_t errors_count4,uint32_t onboard_control_sensors_present_extended,uint32_t onboard_control_sensors_enabled_extended,uint32_t onboard_control_sensors_health_extended,uint32_t pos_Cflags,uint32_t pos_Aflags,uint16_t IMU_Cflags,uint16_t IMU_Aflags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    msg->msgid = MAVLINK_MSG_ID_SYS_STATUS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SYS_STATUS_LEN, MAVLINK_MSG_ID_SYS_STATUS_LEN, MAVLINK_MSG_ID_SYS_STATUS_CRC);
}
...
/**
 * @brief Get field pos_Cflags from sys_status message
 *
 * @return  Bitmap indicating which position sensor is connected.
 */
static inline uint32_t mavlink_msg_sys_status_get_pos_Cflags(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  43);
}

/**
 * @brief Get field pos_Aflags from sys_status message
 *
 * @return  Bitmap indicating which position sensor is available.
 */
static inline uint32_t mavlink_msg_sys_status_get_pos_Aflags(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  47);
}

/**
 * @brief Get field IMU_Cflags from sys_status message
 *
 * @return  Bitmap indicating which IMU sensor is connected.
 */
static inline uint16_t mavlink_msg_sys_status_get_IMU_Cflags(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  51);
}

/**
 * @brief Get field IMU_Aflags from sys_status message
 *
 * @return  Bitmap indicating which IMU sensor is calibrated.
 */
static inline uint16_t mavlink_msg_sys_status_get_IMU_Aflags(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  53);
}
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
    ...
    sys_status->pos_Cflags = mavlink_msg_sys_status_get_pos_Cflags(msg);
    sys_status->pos_Aflags = mavlink_msg_sys_status_get_pos_Aflags(msg);
    sys_status->IMU_Cflags = mavlink_msg_sys_status_get_IMU_Cflags(msg);
    sys_status->IMU_Aflags = mavlink_msg_sys_status_get_IMU_Aflags(msg);
#else
