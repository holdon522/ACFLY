/** @file
 *    @brief MAVLink comm protocol testsuite generated from commonACFly.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef COMMONACFLY_TESTSUITE_H
#define COMMONACFLY_TESTSUITE_H
...
static void mavlink_test_minimalACFly(uint8_t, uint8_t, mavlink_message_t *last_msg);
static void mavlink_test_commonACFly(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_minimalACFly(system_id, component_id, last_msg);
    mavlink_test_commonACFly(system_id, component_id, last_msg);
}
#endif

#include "../minimalACFly/testsuite.h"
...
static void mavlink_test_acflysensors_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACFlySensors_STATUS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_acflysensors_status_t packet_in = {
        93372036854775807ULL,963497880,963498088,18067,18171
    };
    mavlink_acflysensors_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.pos_Cflags = packet_in.pos_Cflags;
        packet1.pos_Aflags = packet_in.pos_Aflags;
        packet1.IMU_Cflags = packet_in.IMU_Cflags;
        packet1.IMU_Aflags = packet_in.IMU_Aflags;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ACFlySensors_STATUS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACFlySensors_STATUS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflysensors_status_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_acflysensors_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflysensors_status_pack(system_id, component_id, &msg , packet1.time_usec , packet1.pos_Cflags , packet1.pos_Aflags , packet1.IMU_Cflags , packet1.IMU_Aflags );
    mavlink_msg_acflysensors_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflysensors_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.pos_Cflags , packet1.pos_Aflags , packet1.IMU_Cflags , packet1.IMU_Aflags );
    mavlink_msg_acflysensors_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_acflysensors_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflysensors_status_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.pos_Cflags , packet1.pos_Aflags , packet1.IMU_Cflags , packet1.IMU_Aflags );
    mavlink_msg_acflysensors_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_acflypossensor_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ACFlyPosSensor_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_acflypossensor_info_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,963499128,963499336,297.0,325.0,353.0,{ 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176 },209,20,87,154
    };
    mavlink_acflypossensor_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        ...
        packet1.trustXY = packet_in.trustXY;
        packet1.trustZ = packet_in.trustZ;
        packet1.ind = packet_in.ind;
        packet1.available = packet_in.available;
        packet1.type = packet_in.type;
        packet1.DataType = packet_in.DataType;
        
        mav_array_memcpy(packet1.name, packet_in.name, sizeof(uint8_t)*16);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ACFlyPosSensor_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ACFlyPosSensor_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflypossensor_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_acflypossensor_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflypossensor_info_pack(system_id, component_id, &msg , packet1.time_usec , packet1.name , packet1.ind , packet1.available , packet1.type , packet1.DataType , packet1.posN , packet1.posE , packet1.posD , packet1.velN , packet1.velE , packet1.velD , packet1.Lat , packet1.Lon , packet1.delay , packet1.trustXY , packet1.trustZ );
    mavlink_msg_acflypossensor_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflypossensor_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.name , packet1.ind , packet1.available , packet1.type , packet1.DataType , packet1.posN , packet1.posE , packet1.posD , packet1.velN , packet1.velE , packet1.velD , packet1.Lat , packet1.Lon , packet1.delay , packet1.trustXY , packet1.trustZ );
    mavlink_msg_acflypossensor_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_acflypossensor_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_acflypossensor_info_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.name , packet1.ind , packet1.available , packet1.type , packet1.DataType , packet1.posN , packet1.posE , packet1.posD , packet1.velN , packet1.velE , packet1.velD , packet1.Lat , packet1.Lon , packet1.delay , packet1.trustXY , packet1.trustZ );
    mavlink_msg_acflypossensor_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_commonACFly(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_acflysensors_status(system_id, component_id, last_msg);
    mavlink_test_acflypossensor_info(system_id, component_id, last_msg);
